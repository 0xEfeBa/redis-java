...
public class RespParserTest {
    ...
    public void testParseSimpleString() {
        ...
        assertNotNull(token);
        assertEquals(RespToken.Type.SIMPLE_STRING, token.getType());
        assertEquals("OK", new String(token.getData()));
    }
    @Test
    ...
    public void testParseSimpleStringWithSpaces() {
        ...
        assertNotNull(token);
        assertEquals(RespToken.Type.SIMPLE_STRING, token.getType());
        assertEquals("Hello World", new String(token.getData()));
    }
    ...
    public void testParseError() {
        ...
        assertNotNull(token);
        assertEquals(RespToken.Type.ERROR, token.getType());
        assertEquals("ERR unknown command", new String(token.getData()));
    }
    ...
    public void testParsePositiveInteger() {
        ...
        assertNotNull(token);
        assertEquals(RespToken.Type.INTEGER, token.getType());
        assertEquals(1000L, token.getIntegerValue());
    }
    @Test
    ...
    public void testParseNegativeInteger() {
        ...
        assertNotNull(token);
        assertEquals(RespToken.Type.INTEGER, token.getType());
        assertEquals(-456L, token.getIntegerValue());
    }
    @Test
    ...
    public void testParseZeroInteger() {
        ...
        assertNotNull(token);
        assertEquals(RespToken.Type.INTEGER, token.getType());
        assertEquals(0L, token.getIntegerValue());
    }
    ...
    public void testParseBulkString() {
        ...
        assertNotNull(token);
        assertEquals(RespToken.Type.BULK_STRING, token.getType());
        assertEquals("hello", new String(token.getData()));
    }
    @Test
    ...
    public void testParseNullBulkString() {
        ...
        assertNotNull(token);
        assertEquals(RespToken.Type.NULL, token.getType());
        assertTrue(token.isNull(), "isNull");
    }
    @Test
    ...
    public void testParseBulkStringBinaryData() {
        ...
        assertNotNull(token);
        assertEquals(RespToken.Type.BULK_STRING, token.getType());
        assertEquals(3, token.getData().length);
        assertEquals(0, token.getData()[0]);
        assertEquals(1, token.getData()[1]);
        assertEquals(2, token.getData()[2]);
    }
    ...
    public void testParseEmptyArray() {
        RespToken token = parser.parse(wrap("*0\r\n"));
        assertNotNull(token);
        assertEquals(RespToken.Type.ARRAY, token.getType());
        assertEquals(0, token.getArrayLength());
    }
    @Test
    ...
    public void testParseArrayWithBulkStrings() {
        ...
        assertNotNull(token);
        assertEquals(RespToken.Type.ARRAY, token.getType());
        assertEquals(2, token.getArrayLength());
        RespToken[] elems = token.getArrayElements();
        assertEquals("GET", new String(elems[0].getData()));
        assertEquals("mykey", new String(elems[1].getData()));
    }
    @Test
    ...
    public void testParseSetCommand() {
        ...
        assertNotNull(token);
        assertEquals(RespToken.Type.ARRAY, token.getType());
        assertEquals(3, token.getArrayLength());
        RespToken[] elems = token.getArrayElements();
        assertEquals("SET",     new String(elems[0].getData()));
        assertEquals("mykey",   new String(elems[1].getData()));
        assertEquals("myvalue", new String(elems[2].getData()));
    }
    @Test
    ...
    public void testParseArrayMixedTypes() {
        ...
        assertEquals(RespToken.Type.INTEGER, e[0].getType());
        assertEquals(100L, e[0].getIntegerValue());
        assertEquals(RespToken.Type.SIMPLE_STRING, e[1].getType());
        assertEquals("OK", new String(e[1].getData()));
        assertEquals(RespToken.Type.NULL, e[2].getType());
    }
    ...
    public void testDynamicBufferResize_longSimpleString() {
        ...
        assertNotNull(token);
        assertEquals(RespToken.Type.SIMPLE_STRING, token.getType());
        assertEquals(1000, token.getData().length);
    }
    @Test
    ...
    public void testLongArrayLengthLine() {
        ...
        assertNotNull(token);
        assertEquals(RespToken.Type.ARRAY, token.getType());
        assertEquals(1, token.getArrayLength());
        assertEquals("a", new String(token.getArrayElements()[0].getData()));
    }
    ...
    public void testBytesToLong_positive() {
        ...
        assertEquals(12345L, SafeEncoder.bytesToLong(data, 0, data.length));
    }
    @Test

    public void testBytesToLong_negative() {
        byte[] data = "-9876".getBytes();
        assertEquals(-9876L, SafeEncoder.bytesToLong(data, 0, data.length));
    }
    @Test
    ...
    public void testEqualsIgnoreCase() {
        ...
        assertTrue(SafeEncoder.equalsIgnoreCase(lower, 0, lower.length, upper), "get == GET");
    }
}
